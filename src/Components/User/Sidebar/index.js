...
const Item = styled(NavLink)`
  ...
  &:hover {
    ...
    img {
      filter: invert(100%) sepia(0%) saturate(10%) hue-rotate(93deg)
        brightness(103%) contrast(103%);
    }
  }
  img {
...
const Profile = styled.div`
  ...
  align-items: center;
  justify-content: center;
  margin-left: ${(props) => (props.clicked ? "0.4rem" : "0")};
  background-color: var(--black);
  color: var(--white);
  transition: all 0.3s ease;
  img {
      ...
      <SidebarContainer>
        ...
        <SlickBar clicked={click}>
          ...
          >
            ...
            <Text clicked={click}>DietPlan</Text>
          </Item>
          <Item
            onClick={() => setClick(false)}
            activeClassName="active"
          ...
          >
            ...
            <Text clicked={click}>Exercises</Text>
          </Item>
          <Item
            onClick={() => setClick(false)}
            activeClassName="active"
          ...
          >
            <img src={exercise} alt="exercise" />
            <Text clicked={click}>Consult</Text>
          </Item>
          <Item
            onClick={() => setClick(false)}
            activeClassName="active"
